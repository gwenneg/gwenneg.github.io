...
:page-excerpt: The official Claude Code docs describe SHA pinning as a feature but never explain why it matters. This post does, and builds a release pipeline around it.
