...
Open a terminal in either the https://github.com/gwenneg/blog-postgres-execution-time/tree/main/single-table[single-table^] (no partitions) or https://github.com/gwenneg/blog-postgres-execution-time/tree/main/partitioned-table[partitioned-table^] (with partitions) folder from the repository, depending on which approach you want to test.
